import { drawToolIcon } from "../catalog/toolIcons.js";
import { SUPPORTED_DRAW_TOOLS, TOOL_GROUPS, TOOL_LABELS } from "../catalog/toolCatalog.js";
import { CURSOR_TOOLS } from "../registry/toolRegistry.js";
import {
  isFavoriteTool,
  loadFavoriteTools,
...
import { createFavoriteToolbar } from "./favoriteToolbar.js";
import { FAV_STAR_FILLED, FAV_STAR_OUTLINE, FAV_TOOLBAR_TOGGLE } from "./toolbarConstants.js";
import { createFlyoutHost } from "./flyoutHost.js";
import { createToolbarBuilders } from "./toolbarBuilders.js";

/**
 * @param {object} opts
 * @param {ReturnType<import("../controller/drawingController.js").createDrawingController>} opts.controller
...
export function mountMainToolbar(opts) {
  ...
  function selectTool(type, groupId) {
    ...
    if (groupId) groupSelection[groupId] = type;
    clearActiveUi();
