...
import { mountFullscreenMode } from "./fullscreenMode.js";
import { createChartSnapshot } from "./chartSnapshot.js";
import { getLayoutDef, LAYOUT_GROUPS } from "./layoutDefinitions.js";
import { getLayoutIcon } from "./layoutIcons.js";
import { loadSavedLayouts } from "./layoutManager.js";

/**
 * @param {object} opts
 * @param {HTMLElement} opts.mountEl
 * @param {() => import("lightweight-charts").IChartApi | null} opts.getChart
 * @param {import("./layoutManager.js").ReturnType<typeof import("./layoutManager.js").createLayoutManager>} opts.layoutManager
 * @param {() => void} [opts.onSaveLayout]
 * @param {() => void} [opts.onLayoutChange]
 */
export function mountHeaderToolbar(opts) {
  const { mountEl, getChart, layoutManager, onSaveLayout, onLayoutChange } = opts;
  ...
  root.innerHTML = `
    ...
    <div class="tv-header-tools__group">
      <button type="button" class="tv-header-tools__btn" id="header-toolbar-layouts" aria-label="Layout setup" data-tooltip="Layout setup" title="Layout setup" aria-haspopup="menu">
        <span class="tv-header-tools__icon tv-header-tools__icon--layout">${LAYOUT_SETUP}</span>
      </button>
      <div class="tv-header-tools__save-wrap">
        <button type="button" class="tv-header-tools__save-btn" id="header-toolbar-save-load" aria-label="All changes saved" data-tooltip="All changes saved" title="All changes saved" disabled>
  ...
  return { updateSaveState, closeMenu };
}
