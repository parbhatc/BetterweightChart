...
export const DEFAULT_SETTINGS = {
  ...
  canvas: {
    ...
    gridVertColor: "rgba(242, 242, 242, 0.06)",
    gridHorzColor: "rgba(242, 242, 242, 0.06)",
...
export const DATE_FORMAT_OPTIONS = [
  { value: "d_mmm_yy", label: "Mon 29 Sep '97" },
  { value: "dd_mm_yy", label: "29 Sep '97" },
  { value: "mm_dd", label: "Sep 29" },
  { value: "yy_mm_dd", label: "'97 Sep 29" },
];
...
export function resolveSettingsSection(id) {
  return SETTINGS_SECTIONS.some((s) => s.id === id) ? id : "symbol";
}
