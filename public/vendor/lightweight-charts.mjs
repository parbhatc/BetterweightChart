/*!
 * @license
 * TradingView Lightweight Charts™ v5.2.0-dev+202606251640
...
class CustomPriceLineOrderPillsPaneView {
    constructor(series, priceLine) {
        ...
        this._private__rendererData = {
            ...
            _internal_pills: orderLineOptionsDefaults.pills,
...
class Series extends PriceDataSource {
    ...
    _internal_topPaneViews(pane) {
        ...
        res.push(...orderLines.map((line) => line._internal_paneView()));
    ...
    _internal_paneViewsForHoveredSourceOnTop() {
        ...
        const orderLines = this._private__customPriceLines.filter((line) => line._internal_isOrderLine());
        topPaneViews.push(...orderLines.map((line) => line._internal_paneView()));
...
class TimeScale {
    ...
    _private__extrapolatedTimeScalePoint(index) {
        ...
        if (typeof anchorOriginal === 'number') {
            ...
            anchorOriginal !== null &&
            "_internal_timestamp" in anchorOriginal &&
            typeof anchorOriginal._internal_timestamp === 'number') {
            originalTime = {
                _internal_timestamp: (anchorOriginal._internal_timestamp + shift * intervalKey),
            };
        }
        else {
